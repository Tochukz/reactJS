...
//     (combineReducers({colors, sort}), (localStorage['redux-store'])? JSON.parse(localStorage['redux-store']) : initialState);

const storeFactory = () => createStore(combineReducers({colors, sort}), colorsData, applyMiddleware(logger, saver));
