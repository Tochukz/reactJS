...
* If is is an object literal then it must be populated with action creators which will be passed to the wrapped component as func props.
* These action creators passed as func properties, when called, will automatically dispatch it's action.
